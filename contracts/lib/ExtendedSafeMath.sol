...
/**
 * @title ExtendedSafeMath
 * @dev Math operations with safety checks that throw on error, with magnitude operations included for token calculations
 */
library ExtendedSafeMath {
